...
import com.example.testgeneratorphoto.databinding.ActivityLoginBinding
...
class login : AppCompatActivity() {
    ...
    bind.contine4.setOnClickListener {
        auth.signInWithEmailAndPassword(bind.email2.text.toString(), bind.password2.text.toString())
