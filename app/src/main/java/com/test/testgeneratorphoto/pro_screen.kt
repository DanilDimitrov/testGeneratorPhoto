...
import com.test.testgeneratorphoto.databinding.ActivityProScreenBinding
...
// Инициализация PaymentSheet
        ...
        //Terms of Use
        bind.textView24.paintFlags = bind.textView24.paintFlags or Paint.UNDERLINE_TEXT_FLAG
        bind.textView24.setOnClickListener {

        }

        //politica
        bind.textView8.paintFlags = bind.textView8.paintFlags or Paint.UNDERLINE_TEXT_FLAG
        bind.textView8.setOnClickListener {
            val url = "https://reimageapp.ai/privacy-policy"
        ...
        //restore purchase
        bind.textView70.paintFlags = bind.textView70.paintFlags or Paint.UNDERLINE_TEXT_FLAG
        bind.textView70.setOnClickListener {
